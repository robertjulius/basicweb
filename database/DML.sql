...
INSERT INTO ms_module (id, create_by, create_date, update_by, update_date, action, description, name, parent) VALUES ('021module_maintenance', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP, '/modules/test/testFirstEntry.action', 'Menu for module maintenance', 'Module', '020developer');
